...
def print_page():
    st.markdown('# Функции')
    st.write('Примеры встроенных в Python функций: `print()`, `str()`, `int()`, `float()`, `len()`.')
    ...
    Добрый вечер!
        ...
        st.write('При вызове функции можно явно указывать, какому аргументу '
    ...
    Периметр = 14 м., площадь = 12 кв.м.
        ...
        st.write('Если бы мы ошиблись и забыли вернуть строку `text` из функции `show_info()`, '
