...
def print_page():
    ...
    # Не имей 100 рублей, а имей 100 друзей.
        ...
        st.write('В f-строки можно подставлять не только переменные, но и результаты вычислений:')
        st.code("""
    one_hundred = 100
    five_hundred = 500
    ...
    st.write('Библиотека или модуль — это набор готовых функций, объединённых общей темой. '
