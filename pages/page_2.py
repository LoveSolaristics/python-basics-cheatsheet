...
def print_page():
    ...
    Осёл
        ...
        st.write('Переменная `musician` принимает последовательно '
    ...
    я иду тебя искать
        ...
        st.write('Внимание: `range(a, b)` возвращает числа от $a$ до $b-1$. Функция `reversed()` '
    ...
    st.write('Логические выражения могут принимать логические значения '
